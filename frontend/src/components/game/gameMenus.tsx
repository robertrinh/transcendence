...
export function OnlineMenu ( {onPlayRandom, onHostLobby, onJoinLobby, onBack} : OnlineMenuProps) {
	return (
  		<div>
			<Button
				id='btn-play-random'
...
export function HostLobby ( {onCopyLobby } : HostLobbyProps) {
	return (
		<div>
		<input id="req-lobby-id" className="border-4 border-indigo-500 p-2 rounded-xl text-center" placeholder="requesting lobby..."></input>
		<Button
			id='btn-copy-lobby'
			className={"bg-indigo-500 text-white py-2 px-8 uppercase rounded-xl"}
...
export function JoinOwnLobby ({onJoinOwn } : JoinOwnProps) {
	return (
		<div>
			 <Button
				id='btn-join-self'
