...
//         <h1 className="text-6xl font-bold text-white mb-4 drop-shadow-lg">PONG</h1>
//         <p className="text-gray-400 text-lg mb-12">Select Your Game Mode</p>

//         <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl">
//           {/* Single Player Card */}
//           <button
//             onClick={() => onModeSelect('singleplayer')}
//             className="group relative overflow-hidden rounded-lg p-8 bg-gradient-to-br from-blue-600 to-blue-800 hover:from-blue-500 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 shadow-2xl"
//           >
//             <div className="relative z-10">
//               <div className="text-5xl mb-4">👤</div>
//               <h2 className="text-2xl font-bold text-white mb-2">Single Player</h2>
//               <p className="text-blue-100 text-sm">Challenge the AI opponent</p>
//               <p className="text-blue-200 text-xs mt-3">• Easy, Medium, Hard</p>
//             </div>
...
//             className="group relative overflow-hidden rounded-lg p-8 bg-gradient-to-br from-green-600 to-green-800 hover:from-green-500 hover:to-green-700 transition-all duration-300 transform hover:scale-105 shadow-2xl"
//           >
//             <div className="relative z-10">
//               <div className="text-5xl mb-4">👥</div>
//               <h2 className="text-2xl font-bold text-white mb-2">Multiplayer</h2>
//               <p className="text-green-100 text-sm">Play with friends online</p>
//               <p className="text-green-200 text-xs mt-3">• Random • Private Lobby</p>
//             </div>
//             <div className="absolute inset-0 bg-white opacity-0 group-hover:opacity-10 transition-opacity duration-300"></div>
//           </button>
...
//             className="group relative overflow-hidden rounded-lg p-8 bg-gradient-to-br from-purple-600 to-purple-800 hover:from-purple-500 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-2xl"
//           >
//             <div className="relative z-10">
//               <div className="text-5xl mb-4">🏆</div>
//               <h2 className="text-2xl font-bold text-white mb-2">Tournament</h2>
//               <p className="text-purple-100 text-sm">Compete in elimination bracket</p>
//               <p className="text-purple-200 text-xs mt-3">• 4, 8, or 16 Players</p>
//             </div>
//             <div className="absolute inset-0 bg-white opacity-0 group-hover:opacity-10 transition-opacity duration-300"></div>
//           </button>
//         </div>
