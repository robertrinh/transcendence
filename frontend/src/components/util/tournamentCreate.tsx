                ...
                <div className="border-4 p-8 bg-gray-900" style={{
                    ...
                    {activeTournament ? (
                        ...
                        <div className="text-center space-y-6">
                            <p className="text-yellow-300 font-bold uppercase" style={{
                                fontFamily: 'monospace',
                                textShadow: '0 0 5px #ffff00'
                            }}>
                                You already have an active tournament:
                            </p>
                            <p className="text-green-400 text-xl font-black" style={{
                                fontFamily: 'monospace',
                            ...
                            <p className="text-gray-400 text-sm" style={{ fontFamily: 'monospace' }}>
                                Status: {activeTournament.status.toUpperCase()} · {activeTournament.max_participants} players
                            </p>

                            <div className="flex gap-4 mt-4">
                                <button
                                    onClick={handleRejoin}
                                    className="flex-1 p-4 bg-cyan-700 hover:bg-cyan-600 border-4 border-cyan-400 font-black text-cyan-300 uppercase transition-all duration-200 transform hover:scale-105 active:scale-95"
                                    style={{
                                        fontFamily: 'monospace',
