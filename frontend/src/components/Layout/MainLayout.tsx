...
//             {/* TOP NAVBAR - This is your MENU system */}
//             <header className="bg-white shadow-sm border-b border-gray-200 h-16">
//                 <div className="max-w-7xl mx-auto px-4 h-full">
//                     <div className="flex items-center justify-between h-full">
//                         {/* Logo/Brand */}
//                         <div className="bg-gray-900 text-white px-6 py-2 rounded-md">
...
//                                 className={`px-4 py-2 rounded-md border-2 border-gray-900 transition-colors ${
//                                     currentView === 'home' 
...
//                                 <button
//                                     onClick={onLogout}
//                                     className="px-4 py-2 rounded-md border-2 border-red-600 bg-white text-red-600 hover:bg-red-50"
//                                 >
//                                     Logout
//                                 </button>
//                             </div>
...
//                 {/* LEFT SIDE - Main Content (Menu content opens here) */}
//                 <div className="flex-1 p-6 border-r border-gray-200">
//                     <div className="bg-white rounded-lg shadow-sm border border-gray-200 h-full">
//                         {/* This is where all your menu content will show */}
//                         {children}
//                     </div>
//                 </div>
...
//             {/* BOTTOM STATUS BAR */}
//             <footer className="bg-gray-900 text-white h-6 flex items-center px-4">
//                 <div className="text-xs">
//                     Status: {user ? `Connected as ${user.username}` : 'Not logged in'} | 
