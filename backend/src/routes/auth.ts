...
export default async function authRoutes (
    ...
    fastify.post('/auth/login', async (request, reply) => {
        ...
        const user = db.prepare('SELECT id, username, password FROM users WHERE username = ?').get(username) as any
    ...
    //* NEW: Verify/Handshake endpoint — Read token and return user info
    ...
    //* NEW: Logout endpoint (optional, for token blacklisting if needed)
