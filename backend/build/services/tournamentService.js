...
export const tournamentService = {
    ...
    createTournament: (name, description, max_participants) => {
    ...
    leaveTournament: (tournament_id, user_id) => {
        try {
            const status = db.prepare('SELECT status FROM tournaments WHERE id = ?').get(tournament_id);
    ...
    getTournamentParticipants: (tournament_id) => {
        try {
    ...
    getTournamentGames: (tournament_id) => {
